...
(function ($) {
    $.fn.compoObjSelect = function (options) {
        ...
        var OrgControl = function () {
            ...
            t.start = function () {
                console.log(445454);
                app.loadData(set.api + '/general/OrganizationTreeBaseList',
                    {
                        unlimited: true,
                        cache: true,
                        HasSummary: true
        ...
        var PositionControl = function () {
            ...
            setTimeout(function () {
                var globalTimeout;
                $(s.som + ' .search-pos-control').keyup(function () {
                    var key = $(this).val();
        ...
        var TitleControl = function () {
            ...
            var globalTimeout;
            setTimeout(function () {
                $(s.som + ' .search-title-control').keyup(function () {
                    var key = $(this).val();
                    if (globalTimeout != null) {
                        clearTimeout(globalTimeout);
                    }
        ...
        var EmpControl = function () {
            ...
            setTimeout(function () {
                var globalTimeout;
                $(s.som + ' .search-emp-control').keyup(function () {
